...
final class GameTest: XCTestCase {
    ...
    func test_startGame_firstPlayerWinsTheThreeFirstRounds_firstPlayerWinsTheGameAndRoutesToResult() {
        ...
        router.questionResultRequests[2]()
        ...
        router.questionResultRequests[3]()
        ...
        router.questionResultRequests[4]()
        ...
        router.questionResultRequests[5]()
    ...
    private func answerRound(_ number: Int, with player: (answer: String, time: TimeInterval), player2: (answer: String, time: TimeInterval), router: RouterSpy) {
        router.playerTurnRequests[0].onStart()
        let player1TimeTaken: TimeInterval = 0.56
        router.questionsRequests[0].answer("A1", player1TimeTaken)
        router.questionResultRequests[0]()
        ...
        router.questionsRequests[1].answer("A1", player2TimeTaken)
        router.questionResultRequests[1]()
        router.roundResultRequests[number].completion()
    }
}
